...
public class NavigationDrawerFragment extends Fragment {
    ...
    public static List<NavInfo> getData() {
        ...
        int[] icons = {R.drawable.ic_category_food, R.drawable.ic_category_shopping, R.drawable.ic_divider, R.drawable.ic_card_email, R.drawable.ic_action};
        String[] titles = {"Cafe Menu", "Your Cart", "", "Feedback", "Settings"};
